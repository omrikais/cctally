...
(cd "$work/public" && \
  ...
  git push -q origin main)
echo "skip-0" > skip-file-0.txt
git add skip-file-0.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_0_EOF'
chore: skip commit 0

Public-Skip: true
CCTALLY_SKIP_MSG_0_EOF
echo "skip-1" > skip-file-1.txt
git add skip-file-1.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_1_EOF'
chore: skip commit 1

Public-Skip: true
CCTALLY_SKIP_MSG_1_EOF
echo "skip-2" > skip-file-2.txt
git add skip-file-2.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_2_EOF'
chore: skip commit 2

Public-Skip: true
CCTALLY_SKIP_MSG_2_EOF
echo "skip-3" > skip-file-3.txt
git add skip-file-3.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_3_EOF'
chore: skip commit 3

Public-Skip: true
CCTALLY_SKIP_MSG_3_EOF
echo "skip-4" > skip-file-4.txt
git add skip-file-4.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_4_EOF'
chore: skip commit 4

Public-Skip: true
CCTALLY_SKIP_MSG_4_EOF
echo "skip-5" > skip-file-5.txt
git add skip-file-5.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_5_EOF'
chore: skip commit 5

Public-Skip: true
CCTALLY_SKIP_MSG_5_EOF
echo "skip-6" > skip-file-6.txt
git add skip-file-6.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_6_EOF'
chore: skip commit 6

Public-Skip: true
CCTALLY_SKIP_MSG_6_EOF
echo "skip-7" > skip-file-7.txt
git add skip-file-7.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_7_EOF'
chore: skip commit 7

Public-Skip: true
CCTALLY_SKIP_MSG_7_EOF
echo "skip-8" > skip-file-8.txt
git add skip-file-8.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_8_EOF'
chore: skip commit 8

Public-Skip: true
CCTALLY_SKIP_MSG_8_EOF
echo "skip-9" > skip-file-9.txt
git add skip-file-9.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_9_EOF'
chore: skip commit 9

Public-Skip: true
CCTALLY_SKIP_MSG_9_EOF
echo "skip-10" > skip-file-10.txt
git add skip-file-10.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_10_EOF'
chore: skip commit 10

Public-Skip: true
CCTALLY_SKIP_MSG_10_EOF
echo "skip-11" > skip-file-11.txt
git add skip-file-11.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_11_EOF'
chore: skip commit 11

Public-Skip: true
CCTALLY_SKIP_MSG_11_EOF
echo "skip-12" > skip-file-12.txt
git add skip-file-12.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_12_EOF'
chore: skip commit 12

Public-Skip: true
CCTALLY_SKIP_MSG_12_EOF
echo "skip-13" > skip-file-13.txt
git add skip-file-13.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_13_EOF'
chore: skip commit 13

Public-Skip: true
CCTALLY_SKIP_MSG_13_EOF
echo "skip-14" > skip-file-14.txt
git add skip-file-14.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_14_EOF'
chore: skip commit 14

Public-Skip: true
CCTALLY_SKIP_MSG_14_EOF
echo "skip-15" > skip-file-15.txt
git add skip-file-15.txt
git commit --no-verify -q -F - <<'CCTALLY_SKIP_MSG_15_EOF'
chore: skip commit 15

Public-Skip: true
CCTALLY_SKIP_MSG_15_EOF
git push -q origin main --follow-tags
