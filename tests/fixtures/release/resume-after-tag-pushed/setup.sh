...
(cd "$work/public" && \
  ...
  git push -q origin main)
CCTALLY_RELEASE_DATE_UTC=2026-05-07 GIT_AUTHOR_DATE="2026-05-07T00:00:00+0000" GIT_COMMITTER_DATE="2026-05-07T00:00:00+0000" python3 bin/cctally release patch --no-publish > "$work/_partial.stdout" 2> "$work/_partial.stderr"
