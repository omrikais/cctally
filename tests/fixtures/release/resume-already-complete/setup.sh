...
(cd "$work/public" && \
  ...
  git push -q origin main)
CCTALLY_RELEASE_DATE_UTC=2026-05-07 GIT_AUTHOR_DATE="2026-05-07T00:00:00+0000" GIT_COMMITTER_DATE="2026-05-07T00:00:00+0000" PATH="$work/fake-bin:$PATH" GH_ARGV_LOG="$work/gh-argv.log.partial" GH_NOTES_DEST="$work/gh-notes.partial.txt" python3 bin/cctally release patch > "$work/_partial.stdout" 2> "$work/_partial.stderr"
