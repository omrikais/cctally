...
- **Long Bash output collapses by default.** A Bash card with more than 20 rendered output lines opens collapsed with a `show N lines` hint (see the [code & shell cards](#conversation-viewer-endpoints-plan-2) note).
