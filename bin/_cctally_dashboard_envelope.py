...
def snapshot_to_envelope(snap: "DataSnapshot", *,
    ...
    weekly_env = {
        ...
        # ``build_weekly_view``-sourced totals undercounted the
        # pre-credit row on a credited week, back when the dashboard
        # synthesized that row after the view was built.
        # ``test_weekly_envelope_total_matches_sum_of_visible_rows`` pins
        # the resulting invariant: the envelope's total equals the sum of
