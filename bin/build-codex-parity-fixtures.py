...
def _acceptance_matrix() -> dict:
    ...
    rows = [
        ...
        _row("provider-qualified-collision-safety", "S1", ["all"], "qualified-identity", "supported", ["root-a-collision", "root-b-collision", "claude-collision"], ["tests/test_codex_fused_ingest.py", "tests/test_codex_conversation_api.py", "tests/test_source_aware_share.py", "dashboard/web/src/store/readingPosition.test.ts", "dashboard/web/e2e/codex-reader.spec.ts"], "Qualified identities protect DB, routes, FTS, modals, exports, share, and browser storage."),
        ...
        _row("source-aware-dashboard-share-identity", "S5", ["all"], "share-identity", "supported", ["mixed-source", "root-a-collision"], ["tests/test_dashboard_source_share.py", "dashboard/web/src/share/sourceIdentity.test.tsx"], "Dashboard share, composer, and history preserve source identity."),
        ...
        _row("s5-s8-ui-qa-gates", "S9", ["all"], "ui-certification", "supported", ["mixed-source", "root-a-collision", "nested-child"], ["tests/test_codex_parity_certification.py", "dashboard/web/src/lib/sourceGating.test.ts", "dashboard/web/src/share/sourceIdentity.test.tsx", "dashboard/web/src/store/readingPosition.test.ts", "dashboard/web/e2e/codex-reader.spec.ts", "dashboard/web/e2e/session-e-polish.spec.ts", "bin/cctally-dashboard-test"], "React/CSS tests, typecheck/build, dashboard goldens, and paired Claude/Codex/All browser QA certify S5 and S8."),
        _row("root-docs-cover-both-sources", "S9", ["all"], "documentation", "supported", ["claude-only", "codex-only", "mixed-source"], "tests/test_codex_parity_certification.py", "Root help, commands, dashboard, transcript/share/privacy, config, setup, and doctor docs cover both sources."),
        _row("production-scale-final-certification", "S9", ["all"], "production-scale-certification", "supported", ["modern-full", "mixed-source", "root-a-collision", "root-b-collision", "nested-child", "malformed-tail"], ["tests/test_codex_parity_certification.py", "tests/test_snapshot_bounded_work.py", "tests/test_conversation_assembly_perf.py", "tests/test_dashboard_drill_perf.py", "tests/test_bench.py", "bin/cctally-bench-test"], "S9 certifies production-scale source-qualified ingest, analytics, dashboard, and conversation behavior with structural bounds and the large benchmark corpus."),
        ...
        _row("five-hour-breakdown-per-source", "S2", ["all"], "five-hour-breakdown", "supported", ["modern-full"], ["tests/test_codex_quota_cli.py", "tests/test_codex_quota_projection.py", "bin/cctally-codex-quota-test"], "Claude five-hour-breakdown and Codex native quota breakdown preserve their provider-native window identity rather than slot aliases."),
        _row("codex-refresh-is-local-rollout-reread", "S2", ["codex"], "provider-live-refresh", "unavailable", ["modern-full"], ["tests/test_lib_quota.py", "tests/test_codex_quota_cli.py"], "Codex has no provider-live or OAuth refresh analogue."),
        ...
        _row("dashboard-s5-after-293-s4", "S5", ["all"], "dashboard-sequencing", "supported", ["mixed-source"], ["dashboard/web/src/lib/sourceGating.test.ts", "dashboard/web/e2e/codex-reader.spec.ts"], "S5 shipped after issue 293 S4 and consumes its source-aware dashboard contract."),
        _row("conversation-phase-independently-deferrable", "S6", ["all"], "conversation-phase", "supported", ["modern-full", "nested-child", "mixed-source"], ["tests/test_codex_conversation_normalization.py", "tests/test_codex_conversation_api.py", "dashboard/web/e2e/codex-reader.spec.ts"], "S6 through S8 are shipped and S9 certifies the complete conversation phase without narrowing its truthful provider exceptions."),
    ]
